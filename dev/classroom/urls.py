...
urlpatterns = [
    ...
    path('Partners', classroom.part_view_add.as_view(), name='partners'),
    path('Par_add', classroom.PartCreateView.as_view(), name='part_add'),
#DataBase

    path('database/process/', classroom.DataBaseView.as_view(), name='data_base'),
    path('database/process/activ/<int:pk>/', classroom.ActivBaseView.as_view(), name='activ_base'),

    path('database/process/activ/tasks/<int:pk>/', classroom.TaskBaseView.as_view(), name='task_base'),

    path('database/process/activ/datails/<int:pk>/', classroom.TaskDetaiListView.as_view(), name='task_base_display'),

#Search Items 
    path('Research/items/', classroom.Research, name='search_items'),
    path('Table/items/', classroom.Table.as_view(), name='table_items'),
    #detail_of_search
...
#add activity 
    ...
    path('actor_view_change/<int:pk>/<int:pk_1>', classroom.Actor_change_view.as_view(), name='actor_change'),
    path('delete_actor/<int:pk>/<int:pk_1>', classroom.ActorDeleteView.as_view(), name='delete_actor'),


       #  Adda inputs
    path('input_view_add/', classroom.input_view_add.as_view(), name='input_view_add'),
    path('input_view_change/<int:pk>/<int:pk_1>', classroom.input_change_add.as_view(), name='input_change'),
    path('delete_input/<int:pk>/<int:pk_1>', classroom.InputDeleteView.as_view(), name='delete_input'),
    ...
    path('output_view_change/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.Output_change.as_view(), name='output_change'),
    path('delete_output/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.OutputDeleteView.as_view(), name='delete_output'),
...
#add activity 
    ...
    path('tech_view_change/(?P<int:pk>\d+)/$(?P<int:pk_1>\d+)/$', classroom.tech_change.as_view(), name='tech_change'),
    path('delete/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.techDeleteView.as_view(), name='delete_tech'),
   
   
            #  Adda Skills
    path('skill_view_add/', classroom.skill_view_add.as_view(), name='skill_view_add'),
    path('skill_view_change/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.skill_change.as_view(), name='skill_change'),
    path('skill_delete/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.skillDeleteView.as_view(), name='skill_delete'),  
    
            #  Adda Decision
    path('dec_view_add/', classroom.dec_view_add.as_view(), name='dec_view_add'),
    path('decision_view_change/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.dec_change.as_view(), name='dec_change'),
    path('decision_delete/(?P<int:pk>\d+)/$/(?P<int:pk_1>\d+)/$', classroom.decDeleteView.as_view(), name='delete_dec'),  
